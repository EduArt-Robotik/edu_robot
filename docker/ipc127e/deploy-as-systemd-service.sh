...
systemd_service_file="ipc127e-edu-robot.service"
tag="<docker_compose_file_path>"

echo "Deploying Docker Compose Services for Controlling IPC127e Eduard"
...
# Printing info text.
echo "With following commands you can control the IPC127e systemd service:"
